...
public class MedicalPayment {
	...
	public MedicalPayment(String paymentid, String patientId, String typeofservices, String patientName,
			String hospitalname, String procedures, String date, String slottime, String amount, String paymenttype) {
		super();
